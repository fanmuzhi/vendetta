...
diagPacketFilter.idOrNameMask[Common.ttypes.DiagPacketType.DEBUG_MSG] = [
    Common.ttypes.DiagIdFilterItem(idOrName="0123/0001"),
    Common.ttypes.DiagIdFilterItem(idOrName="0086/0002"),
]

diagPacketFilter.idOrNameMask[Common.ttypes.DiagPacketType.REQUEST] = [
    Common.ttypes.DiagIdFilterItem(idOrName="125"),
    Common.ttypes.DiagIdFilterItem(idOrName="99"),
]
diagPacketFilter.idOrNameMask[Common.ttypes.DiagPacketType.RESPONSE] = [
    Common.ttypes.DiagIdFilterItem(idOrName="125"),
