...
deviceList = client.getDeviceManager().getDevicesForService(ImageManagementService.constants.IMAGE_MANAGEMENT_SERVICE_NAME)

print("\nList of Devices: ")
for device in deviceList:
    print("\nEnable Sahara/Firehose port trace for device: ")
    print(device)
    deviceManager.enableFunctionLog(device, [Common.ttypes.FunctionArea.FUNCTION_AREA_SAHARA_PORT_TRACE, Common.ttypes.FunctionArea.FUNCTION_AREA_FIREHOSE_PORT_TRACE, Common.ttypes.FunctionArea.FUNCTION_AREA_FIREHOSE_LOADER], options)
